...
export const GRADE1_LESSONS: Lesson[] = [
  ...
  P('L01', '第1课', 'a o e', '单韵母', 'v1.mp4', 2),
  P('L02', '第2课', 'i u ü', '单韵母', 'v2.mp4', 2),
  P('L03', '第3课', 'b p m f', '声母', 'v3.mp4', 2),
  P('L04', '第4课', 'd t n l', '声母', 'v4.mp4', 2),
  P('L05', '第5课', 'g k h', '声母', 'v5.mp4', 3),
  P('L06', '第6课', 'j q x', '声母', 'v6.mp4', 3),
  P('L07', '第7课', 'z c s', '声母 平舌音', 'v7.mp4', 3),
  P('L08', '第8课', 'zh ch sh r', '声母 翘舌音', 'v8.mp4', 3),
  { id: 'L08Y', grade: '1', unit: 3, kind: 'pinyin', code: '第9课', name: 'y w', theme: '声母 y w · 整体认读 yi wu yu', textId: undefined, no: '9', group: '拼音' },
  P('L09', '第10课', 'ai ei ui', '复韵母', 'v10.mp4', 4),
  P('L10', '第11课', 'ao ou iu', '复韵母', 'v9.mp4', 4),
  P('L11', '第12课', 'ie üe er', '复韵母 特殊韵母', 'v11.mp4', 4),
  P('L12', '第13课', 'an en in un ün', '前鼻韵母', 'v12.mp4', 4),
  P('L13', '第14课', 'ang eng ing ong', '后鼻韵母', 'v13.mp4', 4),
  // 第五单元 阅读（课文1-4）
