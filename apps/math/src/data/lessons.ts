...
export type LessonCard =
  ...
  | { type: 'choice'; q: string; options: string[]; answer: number; hint?: string }
  ...
  lessons: [
    ...
    },
    {
      ...
      cards: [
        ...
        { type: 'fill', expr: '3 × 3 + 2 = ?', answer: 11 },
        { type: 'fill', expr: '3 × 4 − 1 = ?', answer: 11 },
  ...
  lessons: [
    {
      ...
      cards: [
        ...
        { type: 'choice', q: '下面哪种分法是平均分？',
          options: ['6 块糖分 3 份：2、2、2', '6 块糖分 3 份：1、2、3', '6 块糖分 3 份：2、1、3', '6 块糖分 3 份：1、1、4'], answer: 0 },
  ...
  lessons: [
    ...
    },
    {
      ...
      cards: [
        ...
        { type: 'fill', expr: '1 + 4 = ?', answer: 5 },
        { type: 'fill', expr: '2 + 2 = ?', answer: 4 },
        { type: 'fill', expr: '4 + 1 = ?', answer: 5 },
